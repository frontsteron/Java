...
// В телефонный справочник по одному ключу нужно добавить несколько одинаковых значений.
// В твоей реализации не получится. Требовалось сделать что то похожее как мы на семинаре делали с номером пасспорта.